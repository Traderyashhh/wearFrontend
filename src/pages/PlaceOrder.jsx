...
const PlaceOrder = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        try {
            ...
            switch (method) {
                case 'cod':
                    const resCOD = await axios.post(`${backendUrl}/api/order/place`, orderData, { headers: { token } });
                ...
                case 'cashfree':
                    const resCF = await axios.post(`${backendUrl}/api/order/cashfree`, orderData, { headers: { token } });
                ...
                <div className='mt-12'>
                    ...
                    <div className='flex gap-3 flex-col lg:flex-row'>
                        <div onClick={() => setMethod('cashfree')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
                            ...
                            <img className='h-5 mx-4' src={assets.cashfree_logo || assets.stripe_logo} alt="Cashfree" />
                        </div>
